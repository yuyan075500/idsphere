    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dao.AccountUpdate"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.AccountCreate"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/account/code": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0, \"msg\": \"校验码已发送，5分钟之内有效\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/account/code_verification": {
            "post": {
                "description": "账号相关接口",
                "tags": [
                    "账号管理"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.CodeVerification"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"code\": 0, \"msg\": \"验证成功，本次验证有效期为10分钟\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dao.TaskUpdate"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.TaskCreate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "service.CodeVerification": {
            ...
            "properties": {
                ...
                "validate_type": {
                    "description": "验证类型：1：短信验证码，2：MFA验证码",
                    "type": "integer"
                }
            }
        },
